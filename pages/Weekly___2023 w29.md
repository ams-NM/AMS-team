...
- query-table:: true
  ...
  :query [:find (pull ?b [*])
       ...
       (task ?b #{"TODO" "DONE"})
       (property ?b :date "2023-07-17 Mon")
  ]}
  #+END_QUERY
- query-table:: true
  #+BEGIN_QUERY
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :date "2023-07-18 Tue")
  ]}
  #+END_QUERY
- query-table:: true
  query-properties:: [:block :finish :remark]
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :date "2023-07-19 Wed")
  ]}
  #+END_QUERY
- query-table:: true
  query-properties:: [:block :finish :remark]
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :date "2023-07-20 Thu")
  ]}
  #+END_QUERY
- query-table:: true
  query-properties:: [:block :finish :remark]
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :date "2023-07-21 Fri")
  ]}
  #+END_QUERY