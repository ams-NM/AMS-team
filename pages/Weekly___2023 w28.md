...
- query-table:: true
  ...
  :query [:find (pull ?b [*])
       ...
       (task ?b #{"TODO" "DONE"})
       (property ?b :date "2023-07-10 Mon")
  ]}
  #+END_QUERY
- query-table:: true
  query-properties:: [:block :finish :remark]
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :date "2023-07-11 Tue")
  ]}
  #+END_QUERY
- query-table:: true
  query-properties:: [:block :finish :remark]
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :date "2023-07-12 Wed")
  ]}
  #+END_QUERY
- query-table:: true
  query-properties:: [:block :finish :remark]
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :date "2023-07-13 Thu")
  ]}
  #+END_QUERY
- query-table:: true
  query-properties:: [:block :finish :remark]
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :date "2023-07-14 Fri")
  ]}
  #+END_QUERY