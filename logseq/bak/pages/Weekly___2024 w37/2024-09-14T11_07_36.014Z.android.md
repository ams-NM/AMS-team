...
- query-table:: true
  ...
  :query [:find (pull ?b [*])
       ...
       (task ?b #{"TODO" "DONE"})
       (property ?b :plan "2024-09-09 Mon")
  ]}
  #+END_QUERY
- query-table:: true
  query-properties:: [:block]
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :plan "2024-09-10 Tue")
  ]}
  #+END_QUERY
- query-table:: true
  query-properties:: [:block]
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :plan "2024-09-11 Wed")
  ]}
  #+END_QUERY
- query-table:: true
  query-properties:: [:block]
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :plan "2024-09-12 Thu")
  ]}
  #+END_QUERY
- query-table:: true
  query-properties:: [:block]
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :plan "2024-09-13 Fri")
  ]}
  #+END_QUERY
-
-