...
- query-table:: true
  ...
  :query [:find (pull ?b [*])
       ...
       (task ?b #{"TODO" "DONE"})
       (property ?b :plan "2024-09-23 Mon")
  ]}
  #+END_QUERY
- query-table:: true
  query-properties:: [:block]
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :plan "2024-09-24 Tue")
  ]}
  #+END_QUERY
- query-table:: true
  query-properties:: [:block]
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :plan "2024-09-25 Wed")
  ]}
  #+END_QUERY
- query-table:: true
  query-properties:: [:block]
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :plan "2024-09-26 Thu")
  ]}
  #+END_QUERY
- query-table:: true
  query-properties:: [:block]
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :plan "2024-09-27 Fri")
  ]}
  #+END_QUERY
-
-