...
- query-table:: true
  ...
  :query [:find (pull ?b [*])
       ...
       (task ?b #{"TODO" "DONE"})
       (property ?b :plan "2024-09-16 Mon")
  ]}
  #+END_QUERY
- query-table:: true
  query-properties:: [:block]
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :plan "2024-09-17 Tue")
  ]}
  #+END_QUERY
- query-table:: true
  query-properties:: [:block]
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :plan "2024-09-18 Wed")
  ]}
  #+END_QUERY
- query-table:: true
  query-properties:: [:block]
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :plan "2024-09-19 Thu")
  ]}
  #+END_QUERY
- query-table:: true
  query-properties:: [:block]
  ...
  :query [:find (pull ?b [*])
       ...
       (not (has-property ?parent :template))
       (task ?b #{"TODO" "DONE"})
       (property ?b :plan "2024-09-20 Fri")
  ]}
  #+END_QUERY
-
-